        ...
        return this.props.cart.map((element) => {
           return (
             <tr key={element.id}>
               ...
               <td>{element.name}</td>
               <td>
                 <button onClick={() => this.props.handleQuantity(element, false)} className="btn btn-warning" style={{padding: 4}}>-</button>
                 <span className="mx-1">{element.soLuong}</span>
                 <button onClick={() => this.props.handleQuantity(element, true)} className="btn btn-warning" style={{padding: 4}}>+</button>
               </td>
